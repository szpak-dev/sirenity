SCHEMA = {
    ...
    "paths": {
        "/records": {"get": {"operationId": "list_records", "summary": "List records", "description": "List all records.", "responses": {"200": {"description": "OK"}}}},
        "/records/{record_id}": {
            "parameters": [{"name": "record_id", "in": "path", "required": True, "schema": {"type": "string"}}],
            "get": {"operationId": "get_record", "summary": "Read record", "description": "Read one record.", "responses": {"200": {"description": "OK"}}},
            "patch": {
...
ROUTE_POLICY_SCHEMA = {
    ...
    "paths": {
        "/api/v2/labels": {
            "get": {"operationId": "list_labels", "summary": "List labels", "description": "List all labels.", "responses": {"200": {"description": "OK"}}},
            "post": {"operationId": "create_label", "summary": "Create label", "description": "Create one label.", "responses": {"201": {"description": "Created"}}},
        },
        "/api/v2/teams/{team}/records": {
            "parameters": [{"name": "team", "in": "path", "required": True, "schema": {"type": "string"}}],
            "get": {"operationId": "list_team_records", "summary": "List team records", "description": "List records for one team.", "responses": {"200": {"description": "OK"}}},
        },
        "/api/v2/teams/{team}/records/search": {
            "parameters": [{"name": "team", "in": "path", "required": True, "schema": {"type": "string"}}],
            "get": {"operationId": "search_team_records", "summary": "Search team records", "description": "Search records for one team.", "responses": {"200": {"description": "OK"}}},
        },
        "/api/v2/teams/{team}/records/{record}": {
            ...
            "get": {"operationId": "get_team_record", "summary": "Read team record", "description": "Read one team record.", "responses": {"200": {"description": "OK"}}},
        },
        "/api/v2/teams/{team}/records/{record}/archive": {
            ...
            "post": {"operationId": "archive_team_record", "summary": "Archive team record", "description": "Archive one team record.", "responses": {"204": {"description": "Archived"}}},
        },
        "/api/v2/teams/{team}/records/{record}/reports": {
            ...
            "get": {"operationId": "list_record_reports", "summary": "List record reports", "description": "List reports for one record.", "responses": {"200": {"description": "OK"}}},
        },
    },
}
